...
extern NSString *const GCDBAsyncUdpSocketException;
extern NSString *const GCDBAsyncUdpSocketErrorDomain;

extern NSString *const GCDBAsyncUdpSocketQueueName;
extern NSString *const GCDBAsyncUdpSocketThreadName;

typedef NS_ENUM(NSInteger, GCDBAsyncUdpSocketError) {
	GCDBAsyncUdpSocketNoError = 0,          // Never used
	GCDBAsyncUdpSocketBadConfigError,       // Invalid configuration
	GCDBAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	GCDBAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	GCDBAsyncUdpSocketClosedError,          // The socket was closed
	GCDBAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class GCDBAsyncUdpSocket;

@protocol GCDBAsyncUdpSocketDelegate
@optional
...
**/
- (void)udpSocket:(GCDBAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(GCDBAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(GCDBAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(GCDBAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(GCDBAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(GCDBAsyncUdpSocket *)sock withError:(NSError *)error;
 ...
 * Example:
 * 
 * GCDBAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^GCDBAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id *context);
 ...
 *
**/
typedef BOOL (^GCDBAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface GCDBAsyncUdpSocket : NSObject

/**
 * GCDBAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, GCDBAsyncSocket will automatically create its own socket queue.
...
- (id)initWithDelegate:(id <GCDBAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq;
- (id)initWithDelegate:(id <GCDBAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq;

#pragma mark Configuration

- (id <GCDBAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(id <GCDBAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(id <GCDBAsyncUdpSocketDelegate>)delegate;

- (dispatch_queue_t)delegateQueue;
- (void)setDelegateQueue:(dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegateQueue:(dispatch_queue_t)delegateQueue;

- (void)getDelegate:(id <GCDBAsyncUdpSocketDelegate>*)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr;
- (void)setDelegate:(id <GCDBAsyncUdpSocketDelegate>)delegate delegateQueue:(dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(id <GCDBAsyncUdpSocketDelegate>)delegate delegateQueue:(dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means GCDBAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, GCDBAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, GCDBAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, GCDBAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that GCDBAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about GCDBAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(GCDBAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(GCDBAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * GCDBAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, GCDBAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about GCDBAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(GCDBAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(GCDBAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The GCDBAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally GCDBAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
